...
#import "LMDrawerController.h"

@interface LMDrawerController ()
/**
 *  记录当前正在显示的VC
 */
...
+ (instancetype)shareDrawerVc{
    return (LMDrawerController *)[[UIApplication sharedApplication]keyWindow].rootViewController;
}
/**
 *  快速创建抽屉控制器
 *
